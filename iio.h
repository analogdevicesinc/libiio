 ...
 * iio_context_get_xml. */
__api __check_ret struct iio_context *iio_create_xml_context(
		const char *xml_file);
 ...
 * @return On success, a pointer to an iio_context structure
 * @return On failure, NULL is returned and errno is set appropriately */
__api __check_ret struct iio_context *iio_create_network_context(
		const char *host);
...
__api __check_ret struct iio_context *iio_create_context_from_uri(
		const char *uri);
 ...
 * @return On success, A pointer to an iio_context structure
 * @return On failure, NULL is returned and errno is set appropriately */
__api __check_ret struct iio_context *iio_context_clone(
 ...
 * @param ctx A pointer to an iio_context structure
 * @return A pointer to a static NULL-terminated string */
__api __check_ret __pure const char *iio_context_get_xml(
		const struct iio_context *ctx);
...
__api __check_ret __pure const char *iio_context_get_name(
		const struct iio_context *ctx);
 ...
 * @param dev A pointer to an iio_device structure
 * @return A pointer to a static NULL-terminated string */
__api __check_ret __pure const char *iio_device_get_id(
		const struct iio_device *dev);
...
__api __check_ret __pure const char *iio_device_get_name(
		const struct iio_device *dev);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_device_attr_read_bool(
		const struct iio_device *dev, const char *attr, bool *val);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_device_attr_read_longlong(
		const struct iio_device *dev, const char *attr, long long *val);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_device_attr_read_double(
		const struct iio_device *dev, const char *attr, double *val);
 ...
 * @return On success, the number of bytes written
 * @return On error, a negative errno code is returned */
__api __check_ret ssize_t iio_device_attr_write_raw(
		const struct iio_device *dev, const char *attr, const void *src,
		size_t len);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_device_attr_write_bool(
		const struct iio_device *dev, const char *attr, bool val);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_device_attr_write_double(
		const struct iio_device *dev, const char *attr, double val);
 ...
 * length of the data read. In that case, the rest of the block contains
 * the data. */
__api __check_ret ssize_t iio_device_buffer_attr_read(
		const struct iio_device *dev, const char *attr, char *dst,
		size_t len);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_device_buffer_attr_read_bool(
		const struct iio_device *dev, const char *attr, bool *val);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_device_buffer_attr_read_longlong(
		const struct iio_device *dev, const char *attr, long long *val);
 ...
 * it corresponds to the length of the data to write. In that case, the rest
 * of the block must contain the data. */
__api __check_ret ssize_t iio_device_buffer_attr_write(
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_device_buffer_attr_write_bool(
		const struct iio_device *dev, const char *attr, bool val);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_device_buffer_attr_write_longlong(
		const struct iio_device *dev, const char *attr, long long val);
...
__api __check_ret __pure bool iio_device_is_trigger(
		const struct iio_device *dev);
 ...
 * @param chn A pointer to an iio_channel structure
 * @return A pointer to a static NULL-terminated string */
__api __check_ret __pure const char *iio_channel_get_id(
		const struct iio_channel *chn);
...
__api __check_ret __pure const char *iio_channel_get_name(
		const struct iio_channel *chn);
...
__api __check_ret __pure bool iio_channel_is_output(
		const struct iio_channel *chn);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_channel_attr_read_bool(
		const struct iio_channel *chn, const char *attr, bool *val);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_channel_attr_read_longlong(
		const struct iio_channel *chn, const char *attr,
		long long *val);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_channel_attr_read_double(
		const struct iio_channel *chn, const char *attr, double *val);
 ...
 * @return On success, the number of bytes written
 * @return On error, a negative errno code is returned */
__api __check_ret ssize_t iio_channel_attr_write_raw(
		const struct iio_channel *chn, const char *attr,
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_channel_attr_write_bool(
		const struct iio_channel *chn, const char *attr, bool val);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_channel_attr_write_longlong(
		const struct iio_channel *chn, const char *attr, long long val);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_channel_attr_write_double(
		const struct iio_channel *chn, const char *attr, double val);
...
__api __check_ret struct iio_buffer *iio_device_create_buffer(
 ...
 * @return On error, a negative errno code is returned
 */
__api __check_ret int iio_buffer_set_blocking_mode(
		struct iio_buffer *buf, bool blocking);
 ...
 *
 * <b>NOTE:</b> Only valid for output buffers */
__api __check_ret ssize_t iio_buffer_push_partial(
		struct iio_buffer *buf, size_t samples_count);
...
__api __check_ret ssize_t iio_buffer_foreach_sample(struct iio_buffer *buf,
		ssize_t (*callback)(const struct iio_channel *chn, void *src,
				size_t bytes, void *d),
		void *data);
...
__api void iio_channel_convert(
		const struct iio_channel *chn, void *dst, const void *src);
 ...
 * should be written
 * @param src A pointer to the source buffer containing the sample */
__api void iio_channel_convert_inverse(
		const struct iio_channel *chn, void *dst, const void *src);
 ...
 * the data. */
__api __check_ret ssize_t iio_device_debug_attr_read(
		const struct iio_device *dev, const char *attr, char *dst,
		size_t len);
 ...
 * it corresponds to the length of the data to write. In that case, the rest
 * of the block must contain the data. */
__api __check_ret ssize_t iio_device_debug_attr_write(
		const struct iio_device *dev, const char *attr,
		const char *src);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_device_debug_attr_read_longlong(
		const struct iio_device *dev, const char *attr, long long *val);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_device_debug_attr_read_double(
		const struct iio_device *dev, const char *attr, double *val);
 ...
 * @return On success, 0 is returned
 * @return On error, a negative errno code is returned */
__api __check_ret int iio_device_debug_attr_write_bool(
		const struct iio_device *dev, const char *attr, bool val);
