...
#if defined(__GNUC__) && !defined(MATLAB_MEX_FILE) &&                          \
...
__api void iio_library_get_version(unsigned int *major, unsigned int *minor,
				   char git_tag[8]);
...
iio_create_xml_context(const char *xml_file);
 ...
 * iio_context_get_xml */
__api __check_ret struct iio_context *
iio_create_xml_context_mem(const char *xml, size_t len);
 ...
 * @return A pointer to a static NULL-terminated string */
__api __check_ret __pure const char *
iio_context_get_xml(const struct iio_context *ctx);
...
__api __check_ret __pure const char *
iio_context_get_name(const struct iio_context *ctx);
 ...
 * the current context. */
__api __check_ret __pure const char *
iio_context_get_description(const struct iio_context *ctx);
...
iio_context_get_attrs_count(const struct iio_context *ctx);
 ...
 *
 * Introduced in version 0.9. */
__api __check_ret const char *
iio_context_get_attr_value(const struct iio_context *ctx, const char *name);
 ...
 * @return If the index is invalid, NULL is returned */
__api __check_ret __pure struct iio_device *
...
__api __check_ret __pure const struct iio_context *
 ...
 * @return A pointer to a static NULL-terminated string */
__api __check_ret __pure const char *
iio_device_get_id(const struct iio_device *dev);
...
__api __check_ret __pure unsigned int
iio_device_get_channels_count(const struct iio_device *dev);
...
__api __check_ret __pure unsigned int
iio_device_get_buffer_attrs_count(const struct iio_device *dev);
 ...
 * @return If the index is invalid, NULL is returned */
__api __check_ret __pure struct iio_channel *
iio_device_get_channel(const struct iio_device *dev, unsigned int index);
 ...
 * @return If the index is invalid, NULL is returned */
__api __check_ret __pure const char *
iio_device_get_buffer_attr(const struct iio_device *dev, unsigned int index);
...
__api __check_ret __pure struct iio_channel *
iio_device_find_channel(const struct iio_device *dev, const char *name,
			bool output);
 ...
 * static string from a dynamically allocated string. */
__api __check_ret __pure const char *
iio_device_find_buffer_attr(const struct iio_device *dev, const char *name);
...
iio_device_attr_read_all(struct iio_device *dev,
 ...
 * @return On error, a negative errno code is returned */
__api __check_ret int
iio_device_attr_read_longlong(const struct iio_device *dev, const char *attr,
			      long long *val);
...
iio_device_attr_write_raw(const struct iio_device *dev, const char *attr,
...
__api __check_ret int iio_device_attr_write_all(
		...
		ssize_t (*cb)(struct iio_device *dev, const char *attr,
 ...
 * @return On error, a negative errno code is returned */
__api __check_ret int
iio_device_attr_write_longlong(const struct iio_device *dev, const char *attr,
			       long long val);
 ...
 * the data. */
__api __check_ret ssize_t
iio_device_buffer_attr_read(const struct iio_device *dev, const char *attr,
			    char *dst, size_t len);
 ...
 * command. */
__api __check_ret int iio_device_buffer_attr_read_all(
		struct iio_device *dev,
		int (*cb)(struct iio_device *dev, const char *attr,
			  const char *value, size_t len, void *d),
		void *data);
 ...
 * @return On error, a negative errno code is returned */
__api __check_ret int
iio_device_buffer_attr_read_bool(const struct iio_device *dev, const char *attr,
				 bool *val);
 ...
 * of the block must contain the data. */
__api __check_ret ssize_t
iio_device_buffer_attr_write(const struct iio_device *dev, const char *attr,
			     const char *src);
 ...
 * @return On error, a negative errno code is returned */
__api __check_ret ssize_t
iio_device_buffer_attr_write_raw(const struct iio_device *dev, const char *attr,
				 const void *src, size_t len);
 ...
 * command. */
__api __check_ret int iio_device_buffer_attr_write_all(
		struct iio_device *dev,
		ssize_t (*cb)(struct iio_device *dev, const char *attr,
			      void *buf, size_t len, void *d),
		void *data);
...
__api __check_ret __pure bool
iio_device_is_trigger(const struct iio_device *dev);
 ...
 * @return On error, a negative errno code is returned */
__api __check_ret int
iio_device_set_kernel_buffers_count(const struct iio_device *dev,
...
__api __check_ret __pure const struct iio_device *
...
__api __check_ret __pure bool
iio_channel_is_scan_element(const struct iio_channel *chn);
...
__api __check_ret __pure const char *
iio_channel_attr_get_filename(const struct iio_channel *chn, const char *attr);
 ...
 * command. */
__api __check_ret int
iio_channel_attr_read_all(struct iio_channel *chn,
			  int (*cb)(struct iio_channel *chn, const char *attr,
				    const char *val, size_t len, void *d),
			  void *data);
 ...
 * @return On error, a negative errno code is returned */
__api __check_ret int
iio_channel_attr_read_longlong(const struct iio_channel *chn, const char *attr,
			       long long *val);
 ...
 * @return On error, a negative errno code is returned */
__api __check_ret int
iio_channel_attr_read_double(const struct iio_channel *chn, const char *attr,
			     double *val);
 ...
 * @return On error, a negative errno code is returned */
__api __check_ret ssize_t
iio_channel_attr_write_raw(const struct iio_channel *chn, const char *attr,
			   const void *src, size_t len);
 ...
 * command. */
__api __check_ret int iio_channel_attr_write_all(
		struct iio_channel *chn,
		ssize_t (*cb)(struct iio_channel *chn, const char *attr,
			      void *buf, size_t len, void *d),
		void *data);
 ...
 * @return On error, a negative errno code is returned */
__api __check_ret int
iio_channel_attr_write_longlong(const struct iio_channel *chn, const char *attr,
				long long val);
 ...
 * @return On error, a negative errno code is returned */
__api __check_ret int
iio_channel_attr_write_double(const struct iio_channel *chn, const char *attr,
			      double val);
...
__api __check_ret size_t iio_channel_read(const struct iio_channel *chn,
					  struct iio_buffer *buffer, void *dst,
					  size_t len);
...
__api __check_ret __pure enum iio_chan_type
iio_channel_get_type(const struct iio_channel *chn);

/** @brief Get the modifier type of the given channel
 * @param chn A pointer to an iio_channel structure
 * @return The modifier type of the channel */
__api __check_ret __pure enum iio_modifier
iio_channel_get_modifier(const struct iio_channel *chn);
...
iio_device_create_buffer(const struct iio_device *dev, size_t samples_count,
			 bool cyclic);
 ...
 * @return On error, a negative errno code is returned
 */
__api __check_ret int iio_buffer_set_blocking_mode(struct iio_buffer *buf,
						   bool blocking);
...
__api __check_ret ssize_t
iio_buffer_foreach_sample(struct iio_buffer *buf,
 ...
 * @return On error, a negative errno code is returned */
__api __check_ret __pure long
iio_channel_get_index(const struct iio_channel *chn);

/** @brief Get a pointer to a channel's data format structure
 * @param chn A pointer to an iio_channel structure
 * @return A pointer to the channel's iio_data_format structure */
__api __check_ret __cnst const struct iio_data_format *
...
__api void iio_channel_convert(const struct iio_channel *chn, void *dst,
			       const void *src);
 ...
 * should be written
 * @param src A pointer to the source buffer containing the sample */
__api void iio_channel_convert_inverse(const struct iio_channel *chn, void *dst,
				       const void *src);
 ...
 * of the block must contain the data. */
__api __check_ret ssize_t
iio_device_debug_attr_write(const struct iio_device *dev, const char *attr,
			    const char *src);
 ...
 * @return On error, a negative errno code is returned */
__api __check_ret ssize_t
iio_device_debug_attr_write_raw(const struct iio_device *dev, const char *attr,
				const void *src, size_t len);
 ...
 * @return On error, a negative errno code is returned */
__api __check_ret int
iio_device_debug_attr_read_bool(const struct iio_device *dev, const char *attr,
				bool *val);
 ...
 * @return On error, a negative errno code is returned */
__api __check_ret int
iio_device_debug_attr_write_bool(const struct iio_device *dev, const char *attr,
				 bool val);
