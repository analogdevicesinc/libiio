...
struct iio_backend_ops {
	...
	struct iio_buffer_pdata *(*open_buffer)(const struct iio_device *dev, unsigned int idx,
			struct iio_channels_mask *mask);
	void (*close_buffer)(struct iio_buffer_pdata *pdata);
...
__api struct iio_buffer *iio_device_add_buffer(struct iio_device *dev, unsigned int idx);
...
__api int iio_buffer_add_attr(struct iio_buffer *buf, const char *name);

__api void iio_buffer_set_direction(struct iio_buffer *buf, const char *direction);
