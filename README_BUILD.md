...
When configuring libiio with CMake, this option must be enabled. CMake will then automatically activate the features required for the Microcontroller configuration and disable those that are incompatible with it.
