...
**-V, --version**
   ...
   *iio_genxml* and the version of the libiio library it is using. This
   is useful for knowing if the version of the library and *iio_genxml*
...
**-u, --uri**
   ...
   serial:[port],[baud],[settings]
      ...
      [baud]
         is normally one of 110, 300, 600, 1200, 2400, 4800, 9600,
