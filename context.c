...
"<!ELEMENT device (channel | buffer | attribute | debug-attribute | buffer-attribute | event-attribute)*>"
...
"<!ATTLIST event-attribute name CDATA #REQUIRED value CDATA #IMPLIED>"
"]>";
