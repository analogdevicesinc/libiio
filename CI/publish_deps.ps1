...
if ($COMPILER -eq "MinGW Makefiles") {
	...
	cp C:\ghcup\ghc\9.8.4\mingw\bin\libiconv-2.dll $env:BUILD_ARTIFACTSTAGINGDIRECTORY
	cp C:\ghcup\ghc\9.8.4\mingw\bin\zlib1.dll $env:BUILD_ARTIFACTSTAGINGDIRECTORY
	cp C:\ghcup\ghc\9.8.4\mingw\bin\liblzma-5.dll $env:BUILD_ARTIFACTSTAGINGDIRECTORY
	cp C:\ghcup\ghc\9.8.4\mingw\bin\libwinpthread-1.dll $env:BUILD_ARTIFACTSTAGINGDIRECTORY
	cp C:\ghcup\ghc\9.8.4\mingw\bin\libxml2-2.dll $env:BUILD_ARTIFACTSTAGINGDIRECTORY
